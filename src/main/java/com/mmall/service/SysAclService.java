...
public class SysAclService {
    ...
    public boolean checkExist(int acModuleId, String name, Integer id) {
        return sysAclMapper.countByNameAndAclModuleId(acModuleId, name, id) > 0;
    }
    ...
    public PageResult<SysAcl> getPaeByAclModuleId(int aclModuleId, PageQuery pageQuery) {
